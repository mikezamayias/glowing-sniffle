...
Στην γραμμή \lstinline{1} δημιουργείται μια λίστα με ακέραιους αριθμούς από το \lstinline{0} έως το \lstinline{9} και στην γραμμή \lstinline{4} εκτυπώνεται η λίστα \lstinline{numbers}. Μπορείτε να διαβάσετε την γραμμή \lstinline{9} ως "για κάθε αριθμό στους αριθμούς κάνε:", με "αριθμό" να αποτελεί το αντικείμενο \lstinline{"number"} και "αριθμούς" το αντικείμενο \lstinline{"numbers"}.
