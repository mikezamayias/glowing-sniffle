...
minoc:
    ...
    beq		$19, $22, minac	    # if $19 == $22 then minac
    #   if b and c are equal, then compare a and b
    beq		$20, $22, minab	    # if $20 == $22 then minab
minac:
...
minab:
    ...
    slt     $19, $16, $17       # if $16 < $17 then $19 = 1
    slt     $20, $16, $18       # if $16 < $18 then $20 = 1
    beq		$19, $20, a_min	    # if $19 == $20 then a_min
    #   reset $19 and $20
    and     $19, $21, $22
    and     $20, $22, $22
    #   check if b is the minimum, $19 and $20 must be equal
    slt     $19, $17, $16       # if $17 < $16 then $19 = 1
    slt     $20, $17, $18       # if $17 < $18 then $20 = 1
    beq		$19, $20, b_min	    # if $19 == $20 then b_min
    #   reset $19 and $20
    and     $19, $21, $22
    and     $20, $22, $22
    #   check if c is the minimum, $19 and $20 must be equal
    slt     $19, $18, $16       # if $18 < $16 then $19 = 1
    slt     $20, $18, $17       # if $18 < $17 then $20 = 1
...
maxoc:
    #   if a and b are equal, then compare a and c
    beq		$19, $22, maxac	    # if $19 == $22 then maxac
    #   if b and c are equal, then compare a and b
    beq		$20, $22, maxab	    # if $20 == $22 then maxab
maxac:
...
maxab:
    ...
    sgt     $19, $16, $17       # if $16 > $17 then $19 = 1
    sgt     $20, $16, $18       # if $16 > $18 then $20 = 1
    beq		$19, $20, a_min	    # if $19 == $20 then a_min
    #   reset $19 and $20
    and     $19, $21, $22
    and     $20, $22, $22
    #   check if b is the minimum, $19 and $20 must be equal
    sgt     $19, $17, $16       # if $17 > $16 then $19 = 1
    sgt     $20, $17, $18       # if $17 > $18 then $20 = 1
    beq		$19, $20, b_min	    # if $19 == $20 then b_min
    #   reset $19 and $20
    and     $19, $21, $22
    and     $20, $22, $22
    #   check if c is the minimum, $19 and $20 must be equal
    sgt     $19, $18, $16       # if $18 > $16 then $19 = 1
    sgt     $20, $18, $17       # if $18 > $17 then $20 = 1
    beq		$19, $20, c_min	    # if $19 == $20 then c_min
a_max:
    #   print a
    addi	$2, $0, 1			# $2 = $0 + 1
