...
\begin{figure}
	...
	\caption{\protect\rule{0ex}{0ex}
		Φαίνεται με μπλέ το αρχικό διάνυσμα και με κόκκινο ο
		μετασχηματισμός του.}
	\includegraphics[scale=0.5]{x2.png}
	\caption{Φαίνεται με μπλέ το αρχικό διάνυσμα και με κόκκινο ο
		μετασχηματισμός του.}
\end{figure}
